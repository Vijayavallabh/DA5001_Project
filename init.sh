...
echo "=== Init Complete ==="
echo ""
echo "Phases 1-2 are complete (2026-09-06): feat-001..009, 013..015 and 017..027 are done."
echo "Phase 3 is OPEN (plan v3, 2026-09-07): feat-028..034 target the Sep 29 SaTML submission."
echo "feat-016 is human-only - never start it."
echo ""
echo "If you are here to work:"
echo "1. Read AGENTS.md, then progress.md (bottom first) and session-handoff.md"
echo "2. Pick the lowest-numbered feat-028..034 whose dependencies are done; Sep 20 freezes every headline number"
