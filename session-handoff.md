...
with one clause each in Sections 3, 4 and 5); two post hoc notes (review 2 Q3, Q6) are in the appendix. Body
exactly 9 of 9, 47 pages; guards `tests/test_v14_skipped.py`. Nothing of ours is running on either host. The
one step left is the user's: read the PDF and submit before 26 Sept 17:29 IST.
