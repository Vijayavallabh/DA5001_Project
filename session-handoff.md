...
- **Compute:** ~15.5 GPU-hours planned after feat-028b was blocked (was 19.5; phase 2 was 54.24, `results/compute_hours.csv`). Plan assumes 3 free A100s; at 02:00 on 2026-09-07 only GPU 0 was free with 1, 2 and 4 at 100% under other users. Plan v3 Section 5 gives the drop order: feat-030 first, then feat-032 (which needs 2 cards for the 70B).
