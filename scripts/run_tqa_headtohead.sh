...
set -a; . ./.env; set +a
COMMON="--data-dir data/bench/triviaqa --safe-model-path jacquelinehe/tinycomma-1.8b-llama3-tokenizer --risky-model-path meta-llama/Llama-3.1-8B-Instruct --cap-factual 500 --cap-neutral 0 --cap-creative 0 --cap-val 0 --cap-test 0 --cap-attack-train 0 --max-new-tokens 24"
